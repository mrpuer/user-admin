import { _getAdministration, _interceptReads, action, computed, extendObservable, getAtom, intercept, isComputed, isComputedProp, isObservableArray, isObservableProp, observable, observe, reaction, runInAction, values } from 'mobx';
...
var MapType$$1 = /** @class */ (function (_super) {
    ...
    function MapType$$1(name, subType) {
        ...
        _this.createNewInstance = function () {
            ...
            var map$$1 = observable.map({}, mobxShallow);
...
var ArrayType$$1 = /** @class */ (function (_super) {
    ...
    function ArrayType$$1(name, subType) {
        ...
        _this.createNewInstance = function () {
            var array$$1 = observable.array([], mobxShallow);
