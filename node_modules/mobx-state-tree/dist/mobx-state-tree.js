    ...
    IdentifierCache$$1.prototype.addNodeToCache = function (node) {
        if (node.identifierAttribute) {
            ...
            if (!this.cache.has(identifier$$1)) {
                this.cache.set(identifier$$1, mobx.observable.array([], mobxShallow));
            }
...
var MapType$$1 = /** @class */ (function (_super) {
    ...
    function MapType$$1(name, subType) {
        ...
        _this.createNewInstance = function () {
            ...
            var map$$1 = mobx.observable.map({}, mobxShallow);
        ...
        _this.finalizeNewInstance = function (node, snapshot) {
            ...
            mobx._interceptReads(instance, objNode.unbox);
...
var ArrayType$$1 = /** @class */ (function (_super) {
    ...
    function ArrayType$$1(name, subType) {
        ...
        _this.createNewInstance = function () {
            var array$$1 = mobx.observable.array([], mobxShallow);
        ...
        _this.finalizeNewInstance = function (node, snapshot) {
            var objNode = node;
            var instance = objNode.storedValue;
            mobx._getAdministration(instance).dehancer = objNode.unbox;
...
var ModelType$$1 = /** @class */ (function (_super) {
    ...
    function ModelType$$1(opts) {
        ...
        _this.properties = {};
        _this.createNewInstance = function () {
            var instance = mobx.observable.object(EMPTY_OBJECT, EMPTY_OBJECT, mobxShallow);
    ...
    ModelType$$1.prototype.instantiateVolatileState = function (self, state) {
        ...
        mobx.extendObservable(self, state, EMPTY_OBJECT, mobxShallow);
    };
        ...
        Object.keys(views).forEach(function (key) {
            ...
            if ("get" in descriptor) {
                ...
                if (mobx.isComputed(self.$mobx.values[key])) {
                    ...
                    mobx.extendObservable(self, tmp, EMPTY_OBJECT, mobxShallow);
                }
            }
            else if (typeof value === "function") {
...
exports.joinJsonPath = joinJsonPath$$1;
exports.splitJsonPath = splitJsonPath$$1;
...
exports.getIdentifier = getIdentifier$$1;
